...
type StockReleaseQuantityRequest struct {
	WarehouseId uuid.UUID `json:"warehouseId"`
	ProductId   uuid.UUID `json:"productId"`
	Qty         int       `json:"qty"`
}

func StockReleaseQuantity(authorization string, warehouseId uuid.UUID, productId uuid.UUID, qty int) {
	bodyPayload := StockReleaseQuantityRequest{
